...
export const SKILLS: Record<string, string[]> = {
  ...
  terraform: ['terraform'],
  rest: ['rest', 'restful', 'api rest', 'apis'],
  graphql: ['graphql'],
  microsserviços: ['microsservicos', 'microservices', 'microsserviços'],
  testes: ['testes', 'tdd', 'jest', 'junit', 'cypress', 'selenium', 'playwright', 'qa'],
  scrum: ['scrum', 'agil', 'ágil', 'agile', 'kanban'],
  'power bi': ['power bi', 'powerbi'],
  excel: ['excel', 'planilhas'],
  'pacote office': ['pacote office', 'office', 'word'],
  sap: ['sap'],
  protheus: ['protheus', 'totvs'],
  erp: ['erp'],
  crm: ['crm', 'salesforce', 'hubspot'],
  tableau: ['tableau'],
  'machine learning': ['machine learning', 'ml'],
  'data science': ['data science', 'ciencia de dados', 'ciência de dados'],
  pandas: ['pandas'],
  etl: ['etl'],
  'big data': ['big data', 'spark', 'hadoop'],
  'suporte técnico': ['suporte tecnico', 'suporte técnico', 'help desk', 'helpdesk', 'service desk'],
  redes: ['redes', 'tcp/ip', 'cisco'],
  'active directory': ['active directory', 'ad'],
  windows: ['windows'],
  itil: ['itil'],
  vendas: ['vendas', 'comercial', 'prospeccao', 'prospecção'],
  negociação: ['negociacao', 'negociação'],
  atendimento: ['atendimento', 'atendimento ao cliente'],
  'gestão de pessoas': ['gestao de pessoas', 'gestão de pessoas', 'lideranca', 'liderança'],
  marketing: ['marketing', 'marketing digital'],
  'redes sociais': ['redes sociais', 'social media'],
  financeiro: ['financeiro', 'contas a pagar', 'contas a receber'],
  contabilidade: ['contabilidade', 'contabil', 'contábil'],
  fiscal: ['fiscal', 'tributario', 'tributário', 'pis', 'cofins', 'irpj', 'csll'],
  'recursos humanos': ['recursos humanos', 'rh', 'recrutamento', 'departamento pessoal'],
  logística: ['logistica', 'logística', 'estoque'],
  administrativo: ['administrativo', 'rotinas administrativas'],
  inglês: ['ingles', 'inglês', 'english'],
  espanhol: ['espanhol', 'spanish'],
  comunicação: ['comunicacao', 'comunicação'],
  'trabalho em equipe': ['trabalho em equipe', 'equipe'],
  proatividade: ['proatividade', 'proativo', 'proativa'],
  organização: ['organizacao', 'organização'],
  'resolução de problemas': ['resolucao de problemas', 'resolução de problemas'],
